    ...
    <>
      ...
      <section className="bg-pnp-navy py-12 md:py-16">
        <Container>
          ...
          <p className="mt-6 max-w-4xl text-lg leading-relaxed text-white/85">
            ...
            number routines. Teachers pose purposeful questions, surface
      ...
      <section className="bg-pnp-gray-50 py-12 md:py-16">
        <Container>
          ...
          <div className="mt-6 rounded-xl border-2 border-pnp-navy bg-white p-6 shadow-[4px_4px_0_var(--pnp-navy)]">
            <h3 className="font-heading text-lg font-extrabold text-pnp-navy">
              We are not anti-telling
            </h3>
            <p className="mt-2 leading-relaxed text-pnp-gray-700">
              ...
              keep it brief and broken up with student thinking rather than a
              30&ndash;40 minute monologue.
            </p>
